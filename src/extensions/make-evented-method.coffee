define [
  ...
  Oraculum.makeEventedMethod = (object, methodName, emitter = object, trigger = 'trigger', eventPrefix = '') ->
  ...
  Oraculum.define 'makeEventedMethod', (->
    console?.warn? '''
      Oraculum makeEventedMethod definition has been superceded by the
