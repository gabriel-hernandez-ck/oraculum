require([
  ...
  function coverageReport() {
    ...
    _.each(window._$jscoverage, function(val, key) {
      ...
      totalCoverage.total += cov.total;
      totalCoverage.covered += cov.covered;
      totalCoverage.percentage = (totalCoverage.covered / totalCoverage.total * 100).toFixed(2);
      ...
      _.each(val.source, function(code, idx) {
