(function() {
  ...
  define(['oraculum'], function(Oraculum) {
     ...
     */
    Oraculum.makeMiddlewareMethod = function(object, methodName, emitter, trigger, eventPrefix) {
